...
public class Empleado implements Serializable {
    ...
    @JoinColumn(name = "codestcivil", referencedColumnName = "codigo")
    @ManyToOne
    private Estcivil codestcivil;
    ...
    public Estcivil getCodestcivil() {
        return codestcivil;
    }

    public void setCodestcivil(Estcivil codestcivil) {
